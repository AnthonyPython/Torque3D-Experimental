...
String AssetImporter::getAssetTypeByFile(Torque::Path filePath)
{
   ...
   if (fileExt == String("png") || fileExt == String("jpg") || fileExt == String("jpeg") || fileExt == String("bmp") || fileExt == String("tga") || fileExt == String("hdr") || fileExt == String("dds") || fileExt == String("ies"))
      return "ImageAsset";
